...
void main() {
  group('轮播智能更新测试', () {
    ...
    final List<Map<String, dynamic>> initialData = [
      {
        ...
        "file": {
          ...
          "path":
              "http://idreamsky.oss-cn-beijing.aliyuncs.com/2025-05-22/2c8ea995-ead6-415d-bdfc-cb015542bd60.pdf",
        }
      },
      {
        "id": 136,
        ...
        "file": {
          ...
          "path":
              "http://idreamsky.oss-cn-beijing.aliyuncs.com/2025-08-03/1f87df77-c68a-41bb-9c03-ee27d5718098.pdf",
        }
      },
    ];
    ...
    final List<Map<String, dynamic>> updatedData = [
      {
        ...
        "file": {
          ...
          "path":
              "http://idreamsky.oss-cn-beijing.aliyuncs.com/2025-05-22/67d29806-5a9e-44de-a2c5-12d603336269.pdf",
        }
      },
      {
        "id": 136, // 顺序改变
      ...
      },
      {
        ...
        "file": {
          ...
          "path":
              "http://idreamsky.oss-cn-beijing.aliyuncs.com/2025-08-09/40999997-c367-48a6-9563-f0d1d01ef905.pdf",
        }
      },
      // 注意：id 135 被删除了
    ];
    ...
    testWidgets('测试初始化轮播', (WidgetTester tester) async {
      ...
      // 转换初始数据为模型
      final initialAnnouncements =
          initialData.map((json) => AnnouncementModel.fromJson(json)).toList();
    ...
    testWidgets('测试在查看通告时更新不会退出', (WidgetTester tester) async {
      ...
      final updatedAnnouncements =
          updatedData.map((json) => AnnouncementModel.fromJson(json)).toList();
    ...
    testWidgets('测试删除当前查看的通告时的处理', (WidgetTester tester) async {
      ...
      expect(carouselController.currentIndex,
          lessThanOrEqualTo(carouselController.widgetCount - 1));
    ...
    testWidgets('测试连续多次更新的稳定性', (WidgetTester tester) async {
      ...
      for (int i = 0; i < 5; i++) {
        ...
        expect(carouselController.currentIndex, greaterThanOrEqualTo(0));
        expect(carouselController.currentIndex,
            lessThan(carouselController.widgetCount));
    ...
    test('測試Widget緩存效能', () {
      ...
      final noChangeUpdateTime =
          DateTime.now().difference(updateStartTime).inMicroseconds;
