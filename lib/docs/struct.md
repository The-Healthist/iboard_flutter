...
6. 通告輪播下沒加入大廈繳費總表(已完成)
7. 通告点击显示对应的通告(已完成)
8. 繳費總表(已完成)


1加入實時時間			待啓動				
2繳費表單每一頁後臺設置播放時間			待啓動				
3後臺設置繳費表單每一頁的播放時間	admin web		待啓動		
4通告輪播順序設置,能後臺設置給building			待啓動							
5全屏廣告被打斷 -> 進入首頁頁面,現在被打段,不會進入首頁頁面,而是停留在輪播的通告頁面(但是通告輪播已經被暫停)			待啓動				
6無人操作x秒就跳到通告輪播狀態
7進入通告輪播後無人操作Y秒就跳到全屏廣告			待啓動				
8電子繳費:左邊展示大圖			待啓動				
9檢查更新的功能			待啓動				
